...
//            data.setTime(new Time(11, 20, 0).getTime());
...
//            data.setAirHum(12);
//            data.setDate(new Date(2018, 4, 4));
//            data.setTime(new Time(11, 20, 5).getTime());
...
//            data.setAirHum(13);
//            data.setDate(new Date(2018, 4, 4));
//            data.setTime(new Time(11, 20, 10).getTime());
...
//            data.setAirHum(16);
//            data.setDate(new Date(2018, 4, 4));
//            data.setTime(new Time(11, 20, 15).getTime());
...
//            data.setAirHum(16);
//            data.setDate(new Date(2018, 4, 4));
//            data.setTime(new Time(11, 20, 20).getTime());
//            data.setGroundHum(5);
//            data.setWaterLevel(50);
//            data.setBright(55);
//            dataRepository.save(data);
